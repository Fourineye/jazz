"""
Draw Showcase Scene loaded from JSON.
"""
...
def load_draw_scene() -> Scene:
    json_path = os.path.join(os.path.dirname(__file__), "scenes", "draw_scene.json")
    return Scene.from_json(json_path)

if __name__ == "__main__":
    app = Application(800, 800, "JSON Draw Showcase")
    scene = load_draw_scene()
